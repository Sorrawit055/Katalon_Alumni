...
WebUI.setText(findTestObject('Object Repository/View/Page_/input__s_email'), '614259099@webmail.npru.ac.th')
...
WebUI.click(findTestObject('Object Repository/View/Page_/a_614259099webmail.npru.ac.th'))

WebUI.click(findTestObject('Object Repository/View/Page_/a__1_2'))

WebUI.verifyTextPresent('614259099@webmail.npru.ac.th', false)
